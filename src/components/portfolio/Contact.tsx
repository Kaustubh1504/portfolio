...
const LinkedInIcon = () => <svg fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>;
  ...
  return (
    <section id="contact" className="bg-white pt-3">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-50 rounded-2xl p-8 md:p-12 border border-gray-200 grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Left Side: Contact Info */}
          <div>
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Get in Touch</h3>
            <p className="text-gray-600 mb-8">
              Feel free to reach out via email, phone, or any of my social media platforms. I'm always happy to connect and explore how we can work together.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-gray-700">
                <MailIcon />
                <a href="mailto:kaustubhgharat06@gmail.com" className="hover:text-blue-600">kaustubhgharat06@gmail.com</a>
              </div>
              <div className="flex items-center gap-4 text-gray-700">
                <PhoneIcon />
                <span>(+1) 857-379-6431</span>
              </div>
              <div className="flex items-center gap-4 text-gray-700">
                <LocationIcon />

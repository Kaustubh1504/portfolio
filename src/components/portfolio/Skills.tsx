...
const skillData: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Go", icon: <SkillIcon /> }, { name: "React", icon: <SkillIcon /> },
      { name: "Next.js", icon: <SkillIcon /> }, { name: "Node.js", icon: <SkillIcon /> },
      { name: "Spring Boot", icon: <SkillIcon /> }, { name: "Express.js", icon: <SkillIcon /> },
      { name: "React Native", icon: <SkillIcon /> }, { name: "Expo", icon: <SkillIcon /> },
      { name: "OJET", icon: <SkillIcon /> }, { name: "Microservices", icon: <SkillIcon /> },
  ...
  },
  {
    ...
    color: 'purple',
    skills: [
        { name: "PyTorch", icon: <SkillIcon /> }, { name: "TensorFlow", icon: <SkillIcon /> },
        { name: "Hugging Face", icon: <SkillIcon /> }, { name: "Scikit-learn", icon: <SkillIcon /> },
        { name: "OpenCV", icon: <SkillIcon /> }, { name: "LLMs (GPT-4)", icon: <SkillIcon /> },
        { name: "RAG", icon: <SkillIcon /> }, { name: "LangGraph", icon: <SkillIcon /> },
        { name: "MCP", icon: <SkillIcon /> }, { name: "NLP", icon: <SkillIcon /> },
        { name: "SciBERT", icon: <SkillIcon /> }, { name: "spaCy", icon: <SkillIcon /> },
        { name: "Prodigy", icon: <SkillIcon /> }, { name: "Model Quantization (INT8/FP16)", icon: <SkillIcon /> },
        { name: "SQL", icon: <SkillIcon /> }, { name: "Oracle DB", icon: <SkillIcon /> },
        { name: "MySQL", icon: <SkillIcon /> }, { name: "MariaDB", icon: <SkillIcon /> },
        { name: "MongoDB", icon: <SkillIcon /> }, { name: "Redis", icon: <SkillIcon /> },
        { name: "Firebase", icon: <SkillIcon /> }, { name: "Apache Kafka", icon: <SkillIcon /> },
    ],
  },
  {
    title: "DevOps & Tools",
    ...
    color: 'amber',
    skills: [
      { name: "AWS (EC2, RDS)", icon: <SkillIcon /> }, { name: "Docker", icon: <SkillIcon /> },
      { name: "Kubernetes", icon: <SkillIcon /> }, { name: "Git", icon: <SkillIcon /> },
      { name: "Jenkins", icon: <SkillIcon /> }, { name: "CI/CD", icon: <SkillIcon /> },
      { name: "Linux", icon: <SkillIcon /> }, { name: "Slurm", icon: <SkillIcon /> },
      { name: "Rancher", icon: <SkillIcon /> }, { name: "JMeter", icon: <SkillIcon /> },
      { name: "WebLogic", icon: <SkillIcon /> }, { name: "Selenium", icon: <SkillIcon /> },
      { name: "Vercel", icon: <SkillIcon /> }, { name: "Stripe", icon: <SkillIcon /> },
      { name: "RevenueCat", icon: <SkillIcon /> }, { name: "AR (8thWall)", icon: <SkillIcon /> },
      { name: "NVIDIA Jetson", icon: <SkillIcon /> }, { name: "Agile", icon: <SkillIcon /> },
    ],
  },
];
